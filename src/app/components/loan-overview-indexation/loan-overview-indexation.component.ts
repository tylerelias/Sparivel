...
@Component({
  selector: 'app-loan-overview-indexation',
  templateUrl: './loan-overview-indexation.component.html',
  styleUrls: ['./loan-overview-indexation.component.css']
})
export class LoanOverviewIndexationComponent implements OnInit {
