...
@Component({
  selector: 'app-loan-overview-total-cost',
  templateUrl: './loan-overview-total-cost.component.html',
  styleUrls: ['./loan-overview-total-cost.component.css']
})
export class LoanOverviewTotalCostComponent implements OnInit {
