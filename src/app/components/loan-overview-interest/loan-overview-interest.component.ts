...
@Component({
  selector: 'app-loan-overview-interest',
  templateUrl: './loan-overview-interest.component.html',
  styleUrls: ['./loan-overview-interest.component.css']
})
export class LoanOverviewInterestComponent implements OnInit {
