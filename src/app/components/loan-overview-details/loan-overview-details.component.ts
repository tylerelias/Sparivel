...
@Component({
  selector: 'app-loan-overview-details',
  templateUrl: './loan-overview-details.component.html',
  styleUrls: ['./loan-overview-details.component.css']
})
export class LoanOverviewDetailsComponent implements OnInit {
