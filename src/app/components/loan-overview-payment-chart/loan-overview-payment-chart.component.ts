...
@Component({
  selector: 'app-loan-overview-payment-chart',
  templateUrl: './loan-overview-payment-chart.component.html',
  styleUrls: ['./loan-overview-payment-chart.component.css']
})
export class LoanOverviewPaymentChartComponent implements OnInit {
